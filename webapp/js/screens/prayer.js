...
const PrayerScreen = (function () {
  ...
  const L = {
    ...
    method:     { uz:'Hisoblash usuli',   uz_cyr:'Ҳисоблаш усули',
                  en:'Calculation Method', ru:'Метод расчёта',
                  tr:'Hesaplama Yöntemi',  ar:'طريقة الحساب',
                  kk:'Есептеу әдісі',     tg:'Усули ҳисоб',
                  ky:'Эсептөө ыкмасы',   de:'Berechnungsmethode',
                  fr:'Méthode de calcul', id:'Metode Perhitungan',
                  hi:'गणना विधि',         ur:'حساب کا طریقہ' },
    ...
    humidity:   { uz:'Namlik',       uz_cyr:'Намлик',      en:'Humidity',    ru:'Влажность',
                  ...
                  ky:'Нымдуулук',   de:'Luftfeuchtigkeit', fr:'Humidité',   id:'Kelembaban',
                  hi:'आर्द्रता',    ur:'نمی' },
